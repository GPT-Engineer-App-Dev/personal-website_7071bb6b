    ...
    <Box bg="gray.100" minH="100vh">
      ...
      <Container maxW="container.lg" py={8}>
        ...
        <VStack alignItems="flex-start" spacing={8}>
          ...
          <Text fontSize="lg">2 Academy Awards for Best Actor (Forrest Gump, Philadelphia), 4 Golden Globe Awards, 2 Screen Actors Guild Awards, 7 Primetime Emmy Award nominations</Text>
        </VStack>
      </Container>
    </Box>
  );
